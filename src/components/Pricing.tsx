...
const FEATURE_ROWS: FeatureRow[] = [
  ...
  { label: "All 71 MCP tools (graph · rag · data · journey · memory · registry · scheduler · egress · feedback · schema · admin)", developer: true, production: true, pro: true, enterprise: true },
