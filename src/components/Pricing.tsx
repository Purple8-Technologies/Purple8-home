...
const FEATURE_ROWS: FeatureRow[] = [
  ...
  { label: "All 69 MCP tools (graph · rag · data · journey · memory · registry · scheduler · egress · feedback · schema)", developer: true, production: true, pro: true, enterprise: true },
