...
const STATIC_ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
  ...
  { path: "/products/purple8/agentic-process-automation", priority: 0.9, changeFrequency: "weekly" },
  { path: "/products/purple8/workflow-orchestration", priority: 0.9, changeFrequency: "weekly" },
  { path: "/products/purple8/rag-pipeline", priority: 0.9, changeFrequency: "weekly" },
  { path: "/products/purple8/multi-agent-systems", priority: 0.9, changeFrequency: "weekly" },
  ...
  { path: "/blog/quantum-ai-classical-computing", priority: 0.8, changeFrequency: "monthly" },
