      ...
      <main id="main-content" className="bg-[#0a0a0f] pt-16">
        ...
        <section className="border-t border-purple-900/20">
          <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
              ...
              <div className="rounded-2xl border border-red-900/40 bg-[#11111b] p-7">
                ...
                <div className="mt-5 rounded-xl border border-red-900/30 bg-[#0d0d16] px-4 py-3">
                  ...
                  <p className="mt-1 text-xs text-zinc-600">
                    Every service needs its own cutover signal. Traffic draining must be
                    coordinated. A single incompatible version skew rolls the whole fleet back.
                  </p>
                </div>
              </div>

              {/* Purple8 — the clean way */}
              <div className="rounded-2xl border border-purple-700/40 bg-[#11111b] p-7">
                ...
                <div className="space-y-3">
                  {[
                    {
                      step: "1",
                      title: "Provision green",
                      detail: "Spin up 3 new replicas from the new binary. No external services to update.",
                      colour: "text-emerald-400 border-emerald-900/40",
                    },
                    {
                      step: "2",
                      title: "Warm the HNSW index",
                      detail: "Green replicas replay WAL and rebuild the in-memory vector index from BrickCoreStorage. Typically 60–120 s for multi-million-node corpora.",
                      colour: "text-blue-400 border-blue-900/40",
                    },
                    {
                      step: "3",
                      title: "Cut over load balancer",
                      detail: "LB health checks confirm green is ready → shift 100% traffic in one atomic update. Zero connection drops.",
                      colour: "text-purple-400 border-purple-900/40",
                    },
                    {
                      step: "4",
                      title: "Drain and terminate blue",
                      detail: "In-flight requests complete on the old replicas. Terminate blue. Total downtime: 0 ms.",
                      colour: "text-zinc-400 border-zinc-800",
                    },
                  ].map((s) => (
            ...
            {/* HA topology diagram */}
            <div className="mt-12 rounded-2xl border border-purple-900/30 bg-[#0d0d16] p-8">
              ...
              <div className="relative flex flex-col items-center gap-0">
                ...
                <div className="flex w-full max-w-3xl justify-between px-12 relative" style={{height:"32px"}}>
                  ...
                  <div className="absolute left-[16%] top-0 h-full w-px border-l border-dashed border-purple-800/30" style={{transform:"rotate(0)"}} />
                ...
                <div className="flex w-full max-w-3xl gap-4">
                  <div className="flex-1 rounded-xl border border-zinc-800 bg-[#11111b] px-4 py-3 text-center">
                    <p className="text-[10px] font-semibold text-zinc-400 uppercase tracking-widest">BrickCoreStorage</p>
                    <p className="text-[10px] text-zinc-600 mt-0.5">WAL-replicated · AES-256 at rest</p>
                  </div>
                  <div className="flex-1 rounded-xl border border-zinc-800 bg-[#11111b] px-4 py-3 text-center">
                    <p className="text-[10px] font-semibold text-zinc-400 uppercase tracking-widest">Write-Ahead Log</p>
                    <p className="text-[10px] text-zinc-600 mt-0.5">fsync before mutation · crash-safe replay</p>
                  </div>
                  <div className="flex-1 rounded-xl border border-zinc-800 bg-[#11111b] px-4 py-3 text-center">
                    <p className="text-[10px] font-semibold text-zinc-400 uppercase tracking-widest">Prometheus /metrics</p>
                    <p className="text-[10px] text-zinc-600 mt-0.5">One endpoint · one alert surface</p>
                  </div>
                </div>
              </div>
            </div>

            {/* Comparison callout row */}
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {[
                { label: "Instances for HA", micro: "36+ (3 × 12 services)", p8: "3 replicas", better: true },
                { label: "Rolling update steps", micro: "12 independent rollouts", p8: "1 binary swap", better: true },
                { label: "Version skew risk", micro: "Every service boundary", p8: "None — one release unit", better: true },
              ].map((r) => (
          ...
          <div className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 space-y-6">
              {objections.map((o) => (
                <div
                  key={o.q}
                  className="rounded-2xl border border-purple-900/30 bg-[#11111b] p-7"
                >
                  <p className="text-base font-semibold text-zinc-300 italic">{o.q}</p>
                  <p className="mt-4 text-sm leading-relaxed text-zinc-400">{o.a}</p>
                </div>
              ))}
            </div>
          </div>
